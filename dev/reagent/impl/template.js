...
{return (function() { 
var G__5239__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
var G__5239 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__5239__delegate.call(this,args);};
G__5239.cljs$lang$maxFixedArity = 0;
G__5239.cljs$lang$applyTo = (function (arglist__5240){
var args = cljs.core.seq(arglist__5240);
return G__5239__delegate(args);
});
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__5242 = res;(G__5242[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__5242;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__5243){var vec__5245 = p__5243;var id = cljs.core.nth.call(null,vec__5245,(0),null);var class$ = cljs.core.nth.call(null,vec__5245,(1),null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",-1508377146))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_5246 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_5246 === "key")))
{(o[pname_5246] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__5249 = jsprops;(G__5249["defaultValue"] = value);
(G__5249["value"] = null);
(G__5249["onChange"] = ((function (G__5249,on_change,value){
return (function (p1__5247_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5247_SHARP_);
});})(G__5249,on_change,value))
);
return G__5249;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__5251 = spec;(G__5251["componentDidUpdate"] = ((function (G__5251){
return (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
});})(G__5251))
);
(G__5251["componentWillUnmount"] = ((function (G__5251){
...
return (function (p1__5252_SHARP_,p2__5253_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__5252_SHARP_,p2__5253_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__5255 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__5255,(0),null);var id = cljs.core.nth.call(null,vec__5255,(1),null);var class$ = cljs.core.nth.call(null,vec__5255,(2),null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__5257 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__5257,(0),null);var id_class = cljs.core.nth.call(null,vec__5257,(1),null);return reagent.impl.template.wrap_component.call(null,comp,id_class,(''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(tag)));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,(0)));var jsprops = (function (){var obj5261 = {};(obj5261[reagent.impl.util.cljs_argv] = v);
(obj5261[reagent.impl.util.cljs_level] = level);
return obj5261;
})();var k_5262 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__5263 = (((k_5262 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null)):k_5262);if((k_SINGLEQUOTE__5263 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__5263);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + (1));var n__4400__auto___5264 = a.length;var i_5265 = (0);while(true){
if((i_5265 < n__4400__auto___5264))
{(a[i_5265] = reagent.impl.template.as_component.call(null,(a[i_5265]),level_SINGLEQUOTE_));
{
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4400__auto___5267 = a.length;var i_5268 = (0);while(true){
if((i_5268 < n__4400__auto___5267))
{if((i_5268 >= first_child))
{(a[i_5268] = reagent.impl.template.as_component.call(null,(a[i_5268]),level));
} else
{}
{
