...
{var C_5222 = (a[i]);if(cljs.core.truth_(C_5222.cljsIsDirty))
{C_5222.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_5224 = C.cljsRatom;if(!((ratom_5224 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_5224);
} else
{}
